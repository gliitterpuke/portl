...
var token = result[result.length-5]
var user = result[result.length-4]
var app = result[result.length-3]
var blob = result[result.length-2]
...
class HigherOrderComponent extends Component {
  ...
  uploadSingleFile = () => {
    ...
    const key = user + "/" + app + "/" + tag + "." + filetype
    ...
    .then((response) => {
    return axios.put(baseURL + "blobs/" + blob, data, auth)
      .then((response) => {
