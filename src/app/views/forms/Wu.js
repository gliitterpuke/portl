...
export const Wu = ({ formData, setFormData, nextStep }) => {
  ...
  return (
    <>
      ...
      <MuiPickersUtilsProvider utils={DateFnsUtils}>
        ...
        <Grid item xs={12} md={6}>
            <Field component={KeyboardDatePicker} label="Issue Date" name="natID_natIDdocs_IssueDate_IssueDate" />
        </Grid>
        <Grid item xs={12} md={6}>
            <Field component={KeyboardDatePicker} label="Expiry Date" name="natID_natIDdocs_IssueDate_ExpiryDate" />
        </Grid>
        <Grid item xs={12}>
            <Typography variant="h6" gutterBottom>
              US Identification
