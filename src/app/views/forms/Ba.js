...
export const Ba = ({ formData, setFormData, nextStep }) => {
      ...
      <MuiPickersUtilsProvider utils={DateFnsUtils}>
        ...
        <Grid item xs={12} md={1}>
            <Field
              ...
              helperText={touched.Occupation_OccupationRow1_FromYear && errors.Occupation_OccupationRow1_FromYear}
            />
        </Grid>
        <Grid item xs={12} md={1}>
            <Field
              ...
              helperText={touched.Occupation_OccupationRow1_FromMonth && errors.Occupation_OccupationRow1_FromMonth}
            />
        </Grid>
        ...
        <Grid item xs={12} md={3}>
            <Field
              ...
              renderInput={(params: AutocompleteRenderInputParams) => (
                <TextField
                  {...params}
                  error={touched['Occupation_OccupationRow1_Country_Country'] && !!errors['Occupation_OccupationRow1_Country_Country']}
                  helperText={errors['Occupation_OccupationRow1_Country_Country']}
        ...
        <Grid item xs={12} md={3}>
            <Field
              ...
              renderInput={(params: AutocompleteRenderInputParams) => (
                <TextField
                  {...params}
                  error={touched['Occupation_OccupationRow1_ProvState'] && !!errors['Occupation_OccupationRow1_ProvState']}
                  helperText={errors['Occupation_OccupationRow1_ProvState']}
        ...
        <Grid item xs={12} md={3}>
            <Field
              ...
              renderInput={(params: AutocompleteRenderInputParams) => (
                <TextField
                  {...params}
                  error={touched['Occupation_OccupationRow2_Country_Country'] && !!errors['Occupation_OccupationRow2_Country_Country']}
                  helperText={errors['Occupation_OccupationRow2_Country_Country']}
                  label="Country/Territory"
                  variant="outlined"
                />
              )}
        ...
        <Grid item xs={12} md={3}>
            <Field
              ...
              renderInput={(params: AutocompleteRenderInputParams) => (
                <TextField
                  {...params}
                  error={touched['Occupation_OccupationRow2_ProvState'] && !!errors['Occupation_OccupationRow2_ProvState']}
                  helperText={errors['Occupation_OccupationRow2_ProvState']}
                  label="Province/State"
                  variant="outlined"
                />
              )}
        ...
        <Grid item xs={12} md={3}>
            <Field
              ...
              renderInput={(params: AutocompleteRenderInputParams) => (
                <TextField
                  {...params}
                  error={touched['Occupation_OccupationRow3_Country_Country'] && !!errors['Occupation_OccupationRow3_Country_Country']}
                  helperText={errors['Occupation_OccupationRow3_Country_Country']}
                  label="Country/Territory"
                  variant="outlined"
                />
              )}
        ...
        <Grid item xs={12} md={3}>
            <Field
              ...
              renderInput={(params: AutocompleteRenderInputParams) => (
                <TextField
                  {...params}
                  error={touched['Occupation_OccupationRow3_ProvState'] && !!errors['Occupation_OccupationRow3_ProvState']}
                  helperText={errors['Occupation_OccupationRow3_ProvState']}
                  label="Province/State"
                  variant="outlined"
                />
              )}
